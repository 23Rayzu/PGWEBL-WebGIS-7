        ...
        var point = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                var popupContent = "Nama: " + feature.properties.name + "<br>" +
                    ...
                    "<img src='<?php echo e(asset('storage/images')); ?>/" + feature.properties.image + "' width='200'>";
                layer.on({
                    click: function(e) {
        ...
        var polyline = L.geoJson(null, {
            ...
            onEachFeature: function(feature, layer) {
                var popupContent = "Name: " + feature.properties.name + "<br>" +
                    ...
                    .length_km.toFixed(2) + " km" + "<br>" + "<img src='<?php echo e(asset('storage/images')); ?>/" + feature.properties.image +
                    "' width='200'>";
                layer.on({
                    click: function(e) {
        ...
        var polygon = L.geoJson(null, {
            ...
            onEachFeature: function(feature, layer) {
                var popupContent = "Name: " + feature.properties.name + "<br>" +
                    ...
                    "Luas: " + feature.properties.luas_hektar.toFixed(2) + " ha" + "<br>"
